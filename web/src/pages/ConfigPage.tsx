...
export default function ConfigPage() {
  ...
  useEffect(() => {
    api
      .getConfig()
      .then(setConfig)
      .catch((e) => showToast(`Failed to load config: ${e}`, "error"));
    api
      .getSchema()
      .then((resp) => {
      ...
      .catch((e) => showToast(`Failed to load config schema: ${e}`, "error"));
    api
      .getDefaults()
      .then(setDefaults)
      .catch((e) => showToast(`Failed to load config defaults: ${e}`, "error"));
    api
      .getStatus()
      .then((resp) => setConfigPath(resp.config_path))
      .catch((e) => showToast(`Failed to load status: ${e}`, "error"));
  }, [showToast]);
