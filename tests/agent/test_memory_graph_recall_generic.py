...
def test_cli_auto_recall_uses_default_terminal_namespace(monkeypatch):
    plugin = _load_memory_graph_plugin()
    ...
    assert ns == "telegram:7359770766"
    assert plugin.get_current_namespace() == "telegram:7359770766"
